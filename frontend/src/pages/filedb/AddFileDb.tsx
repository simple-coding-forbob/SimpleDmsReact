...
function AddFileDb() {
  ...
  const insert = async (data: IFileDb, fileData: File | null) => {
    if (!fileData) return alert("파일을 선택해주세요.");
    try {
      await FileDbService.insert(data, fileData);
